            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="<?php echo e(route('home')); ?>">
                        <img src="assets/img/logo.png" alt="logo" class="block h-9 w-auto fill-current text-gray-800">
                    </a>
                </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.responsive-nav-link','data' => ['href' => route('admin'),'active' => request()->routeIs('admin')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php /**PATH C:\laragon\www\carvent\resources\views/layouts/navigation.blade.php ENDPATH**/ ?>