                                ...
                                <tr>
                                    ...
                                    <td class="whitespace-nowrap">
                                        <div class="flex flex-column items-center w-24">
                                            <a href="#"
                                                class="dotbtn btn btn-warning text-white font-bold p-2 rounded-full mb-2"
                                                data-toggle="modal"
                                                data-target="#editCarModal{{ $car->id }}"><span>edit</span></a>
                                            <a href="#"
                                                class="dotbtn btn btn-danger text-white font-bold p-2 rounded-full"
                                                data-toggle="modal"
                                                data-target="#deleteCarModal{{ $car->id }}"><span>delete</span></a>
                                        </div>
                                    </td>
                                </tr>
                            @endforeach
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach ($transactions as $trans)
                                <tr>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-900">
                                            {{ \App\Models\User::find($trans->customer_id)->name }}</div>
                                    </td>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-900">
                                            {{ \App\Models\Car::find($trans->car_id)->name }}</div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-900">
                                            {{ date('Y-m-d', strtotime($trans->start_date)) }}</div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-900">
                                            {{ date('Y-m-d', strtotime($trans->end_date)) }}</div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-900">Rp{{ number_format($trans->total_price) }}
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        @if ($trans->payment_status == 'pending')
                                            <button class="btn btn-warning text-white" disabled>
                                                <div class="text-sm">{{ $trans->payment_status }}</div>
                                            </button>
                                        @elseif ($trans->payment_status == 'completed')
                                            <a class="btn btn-primary text-white" href="/invoice/{{ $trans->id }}">
                                                <div class="text-sm">{{ $trans->payment_status }}</div>
                                            </a>
                                        @endif
                                    </td>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="addCarForm" action="{{ route('car.store') }}" method="POST"
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control mb-2" id="seats" name="seats"
                                min="1" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control mb-2" id="notes" name="notes"
                                rows="3"></input>
                        </div>
                        <div class="form-group">
        ...
        <div class="modal fade" id="editCarModal{{ $car->id }}" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="editCarForm{{ $car->id }}" action="{{ route('car.update', $car->id) }}"
                            ...
                            <div class="form-group">
                                <label for="brand">Brand</label>
                                <input type="text" class="form-control mb-2" id="brand" name="brand"
                            ...
                            <div class="form-group">
                                <label for="year">Year</label>
                                <input type="number" class="form-control mb-2" id="year" name="year"
                                    min="1900" max="2024" value="{{ $car->year }}" required>
                            </div>
                            <div class="form-group">
                                <label for="color">Color</label>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-select mb-2" id="type" name="type" required>
                                    ...
                                    <option value="convertible" {{ $car->type == 'convertible' ? 'selected' : '' }}>
                                        Convertible</option>
                                </select>
                            </div>
                            <div class="form-group">
                                <label for="seats">Seats</label>
                                <input type="number" class="form-control mb-2" id="seats" name="seats"
                                    min="1" value="{{ $car->seats }}" required>
                            </div>
                            <div class="form-group">
                                <label for="transmission">Transmission</label>
                                <select class="form-select mb-2" id="transmission" name="transmission" required>
                            ...
                            <div class="form-group">
                                <label for="price">Price</label>
                                <input type="number" class="form-control mb-2" id="price" name="price"
                                    min="0" step="1.00" value="{{ $car->price }}" required>
                            </div>
                            <div class="form-group">
                                <label for="notes">Notes</label>
                                <input type="text" class="form-control mb-2" id="notes" name="notes"
                                    value="{{ $car->notes }}"></input>
                            </div>
                            <div class="form-group">
                                <label for="photo_url">Photo URL</label>
                                <input type="file" class="form-control mb-2" id="photo_url" name="photo_url">
